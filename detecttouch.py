...
def monitor_chromium():
    ...
    while True:
        try:
            ...
            success = launch_app_as_user("Chromium", ["chromium", "--hide-crash-restore-bubble", "--maximized", "--no-first-run", "--disable-session-crashed-bubble", "--disable-infobars"], "kiosk-user")
